    ...
    <div class="container">
        ...
        <div class="crumbs">
            <ul id="breadcrumbs" class="breadcrumb">
                ...
                <li> Manage Organizers</li>
            </ul>

            <a href="{{ asset('administrator/add-organizer') }}" class="btn btn-primary pull-right" style="display:inline-block; margin:4px 8px 0 0;">Add Organizer</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align:middle;">
                                ...
                                <a href="edit-organizer/{{ $getCategory->cat_id }}/edit"><img src="{{ asset('public/images/edit-icon.png') }}" alt="Edit" /></a>

                                &nbsp;

                                <a href="{{ URL::to('administrator') }}/manage-organizer/{{ $getCategory->cat_id }}/delete"  onClick="return confirm('Are you sure you want to delete this record ?')"><img src="{{ asset('public/images/delete-icon.png') }}" alt="Delete" /></a>
                            </td>
                        </tr>
                        @php $sl+=1; @endphp
                        @endforeach
